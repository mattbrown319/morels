...
REGION_INDICATORS = {
    "ne": {
        ...
        "taxa": [
            ...
            {"id": 49409, "name": "Mertensia virginica", "common": "Virginia Bluebells",
             "why": "#6 in eastern co-occurrence. Blooms in floodplain forests during peak morel window.", "icon": "flower"},
            {"id": 51502, "name": "Cardamine concatenata", "common": "Cut-leaved Toothwort",
             "why": "Spring ephemeral strong in both eastern and central morel habitats.", "icon": "flower"},
    ...
    "mi": {
        ...
        "taxa": [
            ...
            {"id": 51502, "name": "Cardamine concatenata", "common": "Cut-leaved Toothwort",
             "why": "Strong in eastern forests, shared with central.", "icon": "flower"},
            {"id": 48226, "name": "Symplocarpus foetidus", "common": "Eastern Skunk Cabbage",
             "why": "Earliest spring signal — when it's up, the ground is thawing.", "icon": "leaf"},
            {"id": 940028, "name": "Cerioporus squamosus", "common": "Dryad's Saddle",
    ...
    "mo": {
        ...
        "taxa": [
            ...
            {"id": 47599, "name": "Trillium", "common": "Trillium",
             "why": "Blooms during morel season across eastern and central US.", "icon": "flower"},
            {"id": 62950, "name": "Thalictrum thalictroides", "common": "Rue Anemone",
             "why": "#6 in central/plains co-occurrence data.", "icon": "flower"},
